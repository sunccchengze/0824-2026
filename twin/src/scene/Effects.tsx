import { EffectComposer, Bloom, DepthOfField, Vignette, Noise, SMAA, ChromaticAberration } from '@react-three/postprocessing'
...
export default function Effects() {
  return (
    <EffectComposer multisampling={0}>
      ...
      <DepthOfField focusDistance={0.032} focalLength={0.028} bokehScale={0.75} />
